...
function Hero() {
    return (
        <section className='pt-5'>
            <div className="max-w-[1425px] mx-auto px-5 mt-20">
                <h3 className='text-7xl text-center font-extrabold'>We Build</h3>
                <h3 className='text-7xl text-center font-extrabold'> <span className='bg-gradient-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent'>Productive</span> Apps</h3>
