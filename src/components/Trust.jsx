    ...
    return (
        <section className='bg-gradient-to-r from-[#632EE3]  to-[#9F62F2] py-20'>
            <div className="max-w-[1440px] mx-auto px-5">
                <h3 className='text-3xl md:text-5xl text-white font-bold text-center'>Trusted by Millions, Built for You</h3>
                <div className="grid grid-cols-1 gap-14 lg:grid-cols-3 mt-18">
                    <div className='text-center'>
                        <span className='text-white font-extralight'>Total Downloads</span>
                        <h3 className='font-extrabold text-white text-6xl lg:text-7xl my-3'>29.6M</h3>
                    ...
                    <div className='text-center'>
                        ...
                        <h3 className='font-extrabold text-white text-6xl lg:text-7xl my-3'>906K</h3>
                    ...
                    <div className='text-center'>
                        ...
                        <h3 className='font-extrabold text-white text-6xl lg:text-7xl my-3'>132+</h3>
